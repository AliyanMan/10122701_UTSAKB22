...
import com.example.a10122701_myselfapps.Adapter.GalleryAdapter;
import com.example.a10122701_myselfapps.Model.GalleryModel;
...
public class GalleryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        GalleryModel gallery4 = new GalleryModel(R.drawable.gallery1);
        galleryModel.add(gallery4);
        GalleryModel gallery5 = new GalleryModel(R.drawable.gallery2);
        galleryModel.add(gallery5);
        GalleryModel gallery6 = new GalleryModel(R.drawable.gallery3);
        galleryModel.add(gallery6);
        GalleryModel gallery7 = new GalleryModel(R.drawable.gallery1);
        galleryModel.add(gallery7);
        GalleryModel gallery8 = new GalleryModel(R.drawable.gallery2);
        galleryModel.add(gallery8);
        GalleryModel gallery9 = new GalleryModel(R.drawable.gallery3);
        galleryModel.add(gallery9);
        GalleryModel gallery10 = new GalleryModel(R.drawable.gallery1);
